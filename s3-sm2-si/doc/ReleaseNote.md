...
The config map will be created in kubernetes in the processing namespace and will be named ``s3-sm2-si-tasktables``, to be distinguishable from other tasktable configmaps.
