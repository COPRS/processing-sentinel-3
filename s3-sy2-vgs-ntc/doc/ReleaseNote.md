...
# RS Add-on - S3 L2 SY2 VGS NTC

 
 * [RS Add-on S3 L2 SY2 VGS NTC](#rs-add-on---s3-l2-sy2-vgs-ntc)
    * [Overview](#overview)
...
The config map will be created in kubernetes in the processing namespace and will be named ``s3-sy2-vgs-ntc-tasktables``, to be distinguishable from other tasktable configmaps.
...
This config map will be created in kubernetes in the processing namespace and will be named ``s3-sy2-vgs-ntc-joborderxslt``, to be distinguishable from other tasktable configmaps.
